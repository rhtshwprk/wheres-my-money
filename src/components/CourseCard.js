    ...
    >
      <div className={styles.icon}>
        {props.complete === "0" && (
          ...
          >
            <path
              d="M2 12C2 6.47728 6.47728 2 12 2C17.5227 2 22 6.47728 22 12C22 17.5227 17.5227 22 12 22C6.47728 22 2 17.5227 2 12Z"
              stroke="#E6B760"
              stroke-width="2"
            />
          </svg>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.lesson_name}>{props.lesson_name}</div>
